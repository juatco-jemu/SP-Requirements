...
import { TransactionDetails, CollectionDetails } from "../../../data/models/TransactionModel";
  ...
  return (
    <>
      {loading ? (
        ...
        <CustomModal onClose={onClose} className="w-full max-w-3xl max-h-screen overflow-y-auto">
            ...
            <div>
              <div className="mb-4">
                ...
                <TextInput
                  ...
                  className="mt-2 block w-full border border-gray-300 rounded-md shadow-sm bg-gray-100 no-select"
                />
              </div>
              <div className="mb-4">
